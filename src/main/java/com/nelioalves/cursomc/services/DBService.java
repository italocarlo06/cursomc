...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat5 = new Categoria(null,"Gardinagem");
		...
		Cliente cli1 = new Cliente(null,"Maria Silva", "italocarlo06@gmail.com","36378912377",TipoCliente.PESSOAFISICA,bcp.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));
		
		Endereco e1 = new Endereco(null,"Rua","Flores","300","Apto 203","Jardim","38220834",c1,cli1);
		Endereco e2 = new Endereco(null, "Rua", "Matos", "105", "Sala 800", "Centro", "38777012", c2, cli1);
		
		
		cli1.getEnderecos().addAll(Arrays.asList(e1,e2));
		
		Cliente cli2 = new Cliente(null,"Italo Carlo", "italocarlo@nti.ufal.br","03674233401",TipoCliente.PESSOAFISICA,bcp.encode("123"));
		Endereco e3 = new Endereco(null, "Rua", "Antonio Barbosa da Silva", "707", "", "Canafístula", "38777012", c2, cli2);
		cli2.getEnderecos().addAll(Arrays.asList(e3));
		cli2.getTelefones().addAll(Arrays.asList("35397409","988394389"));
